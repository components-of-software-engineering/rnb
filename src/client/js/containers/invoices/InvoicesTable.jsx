...
import { isAdministrator as checkAdminRole } from '../../utils/service';
...
class InvoicesTable extends Component {
    ...
    textInfo(invoices, searchQuery, searchType, isAdministrator) {
        if (searchQuery && searchQuery.trim()) {
            return (
                <React.Fragment>
                    <p>
                        Результати пошуку{!isAdministrator && " серед моїх"} транспортних накладних за запитом 
                        ...
                        ?
                            <p>
                                ...
                                наданим пошуковим запитом{!isAdministrator && " серед моїх ТТН"}. На даній сторінці показано 
                ...
                <React.Fragment>
                    {invoices.data.length > 0 ?
                        <p>
                            ...
                            <b> {invoices.totalCount}</b> доступної(-их) на даний момент{!isAdministrator && " у особистому розпорядженні"}.
                        </p>
                        :
                        <p>
                            На жаль, на даний момент немає{!isAdministrator && " ваших"} накладних.
                        </p>
                    }
                </React.Fragment>
            );
