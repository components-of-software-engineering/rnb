...
class CheckFormSpecialPage extends Component {
    constructor(props) {
        super(props);
        this.state = {
            serial: '',
...
CheckFormSpecialPage.propTypes = {
    specialForm: PropTypes.object.isRequired,
    history: PropTypes.object.isRequired
};

export default withRouter(connect(CheckFormSpecialPage.mapStateToProps, CheckFormSpecialPage.mapDispatchToProps)(CheckFormSpecialPage));
