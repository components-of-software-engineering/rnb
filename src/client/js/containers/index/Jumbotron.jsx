            ...
            <div className="jumbotron">
                <div className="row">
                    ...
                    <div className="col">
                        ...
                        <h3>Реєстр спеціальних бланків нотаріальних документів</h3>
                        <p className="lead">
                            Даний сайт надає можливість користуватися послугами реєстру
                            <b> RNB</b> онлайн, а саме: дізнаватися дату викорисатння, 
                            статус використання та <i>багато чого іншого.</i>
                        </p>
                        <hr className="my-4"/>
