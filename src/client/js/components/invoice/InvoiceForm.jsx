...
import Input from '../partials/form_elements/Input';
...
class InvoiceForm extends Component {
    ...
    handleRegistryChange(e) {
        if (isAdministrator(this.props.user.role) && this.state.recipientLogin) {
    ...
    handleRecipientChange(e) {
        if (isAdministrator(this.props.user.role) && this.state.registryNum) {
    ...
    render() {
        ...
        if (!this.checkAbilityToCreateInvoice(this.props.registriesArr, isAdministrator(this.props.user.role))) {
            return (
                <React.Fragment>
            ...
            <React.Fragment>
                ...
                <form id="insert-invoice" className="form-default mx-auto mb-4 p-4 needs-validation" ref={this.refForm} encType="multipart/form-data" onSubmit={this.formOnSubmit} noValidate>
                    <div className="form-group form-inline ">
                        <Input 
                            type={this.props.user && isAdministrator(this.props.user.role) ? "select-group" : "select" }
                            name="registryNum"
                            label="Реєстр"
