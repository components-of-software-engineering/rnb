        ...
        <ErrorBoundary>
          <Switch>
            ...
            <Route
              exact
              path="/registers"
              component={AuthenticatedComponent(UsersPage, [isAdministrator])}
            />
            <Route
              path="/registers/signup"
              component={AuthenticatedComponent(RegisterPage, [
                isAdministrator,
              ])}
            />
            <Route
              path="/registers/edit/:username([A-Za-z_0-9]{5,20})"
              component={AuthenticatedComponent(EditUserPage, [
                isAdministrator,
              ])}
            />
            <Route
              path="/registers/update/:username([A-Za-z_0-9]{5,20})"
              component={AuthenticatedComponent(UpdateUserPage, [
                isAdministrator,
              ])}
            />
            <Route
              exact
              path="/specialForms"
              component={AuthenticatedComponent(FormsPage, [isAdministrator])}
            />
            <Route
              exact
              path="/notaries"
              component={AuthenticatedComponent(NotariesPage, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              path="/notaries/:id(\d{1,1000})"
              component={AuthenticatedComponent(NotariesInfo, [
                isAdministrator,
                isRegister,
              ])}
            />
            ...
            <Route
              exact
              path="/forms"
              component={AuthenticatedComponent(SpecialFormsPage, [isRegister])}
            />
            <Route
              exact
              path="/forms/add"
              component={AuthenticatedComponent(NewForm, [isRegister])}
            />

            <Route
              exact
              path="/users/me"
              component={AuthenticatedComponent(MyUserPage, false)}
            />
            <Route
              path="/users/me/edit"
              component={AuthenticatedComponent(EditUserPage, false)}
            />
            <Route
              path="/users/:username([A-Za-z_0-9]{5,20})"
              component={AuthenticatedComponent(UserPage, [isAdministrator])}
            />
            <Route
              exact
              path="/registries/"
              component={AuthenticatedComponent(RegistriesTable, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              exact
              path="/registries/:number(\d{5})"
              component={AuthenticatedComponent(RegistryPage, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              path="/registries/:number(\d{5})/edit"
              component={AuthenticatedComponent(EditRegistry, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              path="/registries/new"
              component={AuthenticatedComponent(NewRegistry, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              exact
              path="/invoices/"
              component={AuthenticatedComponent(InvoicesTable, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              exact
              path="/invoices/:number(\d{6})"
              component={AuthenticatedComponent(InvoicePage, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              path="/invoices/:number(\d{6})/edit"
              component={AuthenticatedComponent(EditInvoice, [
                isAdministrator,
                isRegister,
              ])}
            />
            <Route
              path="/invoices/new"
              component={AuthenticatedComponent(NewInvoice, [
                isAdministrator,
                isRegister,
              ])}
            />
